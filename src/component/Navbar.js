        ...
        <div >
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-light" >
                <div className="container-fluid" style={{ backgroundColor: "white" }}>
                    <a className="navbar-brand" href="#"><img src={require('../asset/images/logo.png')} style={{ width: "40px" }} /></a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li>
                                ...
                                <img src={require('../asset/images/notification.png')}
                            ...
                            <li className="nav-item dropdown">
                                <a className="nav-link dropdown" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src={require('../asset/images/profile.png')} style={{ color: "gray", cursor: "pointer" }}></img>
                                </a>
                                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li>
                                ...
                                <img src={require('../asset/images/wallet.png')} style={{ color: "gray", cursor: "pointer", marginTop: "6px" }}></img>
                            </li>
